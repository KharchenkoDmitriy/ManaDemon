...
S.Load({
    ...
    "Engine/SimModel.lua", "Engine/FightRecorder.lua", "Engine/RunRecorder.lua", "Engine/Intuition.lua", "Engine/SimSolver.lua",
    "Engine/SimPlanner.lua", "Engine/ReplayTrace.lua",
